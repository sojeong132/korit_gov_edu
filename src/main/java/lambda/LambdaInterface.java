...
public class LambdaInterface {
    public static void main(String[] args) {
        ...
        String nameText = fx.apply("김일");
        System.out.println(nameText);

        UnaryOperator<String> fx2 = name -> "이름 : " + name;
        nameText = fx2.apply("김일");
        System.out.println(nameText);

        // predicate
        String searchName = "김일";
        List<String> 일학년이름 = List.of("김일", "김이", "김삼");
        List<String> 이학년이름 = List.of("김사", "김오", "김육");
...
//        numStream.forEach(n -> System.out.println(n));
        ...
        List<String> newDateList2 = dataList.stream()
